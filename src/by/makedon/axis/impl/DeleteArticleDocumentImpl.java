 ...
 */
public class DeleteArticleDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements by.makedon.axis.DeleteArticleDocument
{
    ...
    private static final javax.xml.namespace.QName DELETEARTICLE$0 = 
        new javax.xml.namespace.QName("http://axis.makedon.by", "deleteArticle");
    
    
    /**
     * Gets the "deleteArticle" element
     */
    public by.makedon.axis.DeleteArticleDocument.DeleteArticle getDeleteArticle()
    {
        synchronized (monitor())
        {
            check_orphaned();
            by.makedon.axis.DeleteArticleDocument.DeleteArticle target = null;
            target = (by.makedon.axis.DeleteArticleDocument.DeleteArticle)get_store().find_element_user(DELETEARTICLE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setDeleteArticle(by.makedon.axis.DeleteArticleDocument.DeleteArticle deleteArticle)
    {
     ...
     */
    public by.makedon.axis.DeleteArticleDocument.DeleteArticle addNewDeleteArticle()
    {
        synchronized (monitor())
        {
            check_orphaned();
            by.makedon.axis.DeleteArticleDocument.DeleteArticle target = null;
            target = (by.makedon.axis.DeleteArticleDocument.DeleteArticle)get_store().add_element_user(DELETEARTICLE$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class DeleteArticleImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements by.makedon.axis.DeleteArticleDocument.DeleteArticle
    {
        private static final long serialVersionUID = 1L;
