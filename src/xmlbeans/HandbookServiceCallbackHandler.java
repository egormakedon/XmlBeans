...
public abstract class HandbookServiceCallbackHandler {
    ...
    public void receiveResulttakeArticleList(
        by.makedon.axis.TakeArticleListResponseDocument result) {
    }
     ...
     */
    public void receiveResultadd(by.makedon.axis.AddResponseDocument result) {
    }
    ...
    public void receiveResultupdateArticle(
        by.makedon.axis.UpdateArticleResponseDocument result) {
    }
    ...
    public void receiveResultdeleteArticle(
        by.makedon.axis.DeleteArticleResponseDocument result) {
    }
    ...
    public void receiveResulttakeArticle(
        by.makedon.axis.TakeArticleResponseDocument result) {
    }
